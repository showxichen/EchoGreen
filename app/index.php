  ...
  <section id="page-container">
    ...
    <section id="page-hero">
      <div class="site-inner">
        ...
        <h1 class="heading h-01">Welcome to EchoGreen</h1>
        <p class="sub-header copy-02">This is the website of EchoGreen made by Polytech Orléans and LAB'O.</p>
    ...
    <section id="page-about" class="section">
      <div class="site-inner">
        <h1 class="heading h-01">Introduction of our product</h1>
        <p class="copy-01">EchoGreen is able to monitor the electrocardiogram of plants under different kinds of stress. The goal is to identify the type of stress and to help the plants grow in a healtier way.  </p>
        <p class="copy-01"></p>

        <h2 class="heading h-01">Introduction of our team</h2>

        <div class="columns">
          <aside>
            <h3 class="heading h-03">Zuokun.OUYANG</h3>
            <p class="copy-02">Responsible for classification of the stress using machine learning.</p>
          </aside>

          <aside>
            <h3 class="heading h-03">Thibault.VALLIN</h3>
            <p class="copy-02">Responsible for the transmission by developing the LoRa network.</p>
          </aside>

          <aside>
            <h3 class="heading h-03">Xi.CHEN</h3>
            <p class="copy-02">Responsible for the website and the database of EchoGreen. </p>
          </aside>
        </div>
    ...
    <section id="page-work" class="section">
      <div class="my-work-container">
        <div class="site-inner">
          <h1 class="heading h-01">About our product</h1>
        </div>

        <a href="#" class="mobile-filter-select">Filter</a>
        <nav id="work-filter">
          <a href="#" class="filter-link active" data-group="All">All parts</a>
          <a href="#" class="filter-link" data-group="Database">Database and web design</a>
          <a href="#" class="filter-link" data-group="Identify">Identify the type of stress</a>
          <a href="#" class="filter-link" data-group="Communication">Communication</a>
          <a href="#" class="filter-link" data-group="Alarm">Alarm</a>
          <a href="#" class="filter-link" data-group="Project">Project</a>

        </nav>

        <section id="work-grid" class="site-inner">
          
          <div class="work-item" data-groups='["All", "Database"]' data-url="presentation/xi.pdf">
            <figure class="image-container"><img src="images/work/database1.jpg" /></figure>
            <h2 class="heading h-02">MongoDB</h2>
            <p class="copy-03">Database and web design</p>
          </div>

          <div class="work-item" data-groups='["All", "Identify"]' data-url="presentation/zuokun3.pdf">
            <figure class="image-container"><img src="images/work/stress1.jpg" /></figure>
            <h2 class="heading h-02">Machine Learning</h2>
            <p class="copy-03">Identify the type of stress</p>
          </div>
        
          <div class="work-item" data-groups='["All", "Communication"]' data-url="presentation/Thibault1.pdf">
            <figure class="image-container"><img src="images/work/communication1.jpg" /></figure>
            <h2 class="heading h-02">LoRa</h2>
            <p class="copy-03">Communication</p>
          </div>
          
          

          <div class="work-item" data-groups='["All", "Alarm"]' >
            <figure class="image-container"><img src="images/work/alarm1.jpg" /></figure>
            <h2 class="heading h-02">Fire-alarm</h2>
            <p class="copy-03">Alarm</p>
          </div>
  
          <div class="work-item" data-groups='["All", "Alarm"]' >
            <figure class="image-container"><img src="images/work/bug1.jpg" /></figure>
            <h2 class="heading h-02">Bug-alarm</h2>
            <p class="copy-03">Alarm</p>
          </div>
          
          <div class="work-item" data-groups='["All", "Project"]' data-url="presentation/project.pdf">
            <figure class="image-container"><img src="images/work/video1.jpg" /></figure>
            <h2 class="heading h-02">Project-introduction</h2>
            <p class="copy-03">Project</p>
        ...
        <a href="#" class="button main rounded">Back to the top</a>
      </div>
    ...
    <section id="page-signup" class="section">
      ...
      <p class="copy-02">Subscribe to our newsletter to receive news, updates, free stuff and new releases by email. </p>
    ...
    <section id="page-footer">
      ...
      <p class="copy-02">Copyright © 2017. All Rights Reserved.</p>
      <p class="copy-02">Made With ❤️ By @Polytech Orléans</p>
